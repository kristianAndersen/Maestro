...
# Phase 2 Validation: Remaining 18 Prompts - BASELINE TEST
# Resets context.json between EACH prompt (simulating pre-defer_loading)
...
# Baseline context template (empty)
BASELINE_CONTEXT='{
  "skillTracking": {
    "recommended": [],
    "used": [],
...
echo "================================================================"
echo "BASELINE TEST - Remaining 18 Prompts"
echo "Running $(date)"
echo "================================================================"
echo ""
...
for i in "${!PROMPTS[@]}"; do
  ...
  # Reset context.json to baseline (empty)
  echo "$BASELINE_CONTEXT" > "$CONTEXT_FILE"
  sleep 0.1

  # Run prompt through hook
...
echo ""
echo "================================================================"
echo "BASELINE TOTALS (18 prompts)"
echo "================================================================"
