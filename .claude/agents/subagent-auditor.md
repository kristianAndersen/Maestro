...
1. Read @skills/agent-creator/SKILL.md for agent creation methodology, XML structure rules, YAML frontmatter conventions, and anti-patterns
2. Read @skills/agent-creator/assets/anatomy.md for full agent anatomy reference, XML section patterns, tool/model selection guides, and structure requirements
3. Read the target subagent configuration file
4. Before penalizing any missing section, search entire file for equivalent content under different tag names
5. Evaluate against best practices from steps 1-2, focusing on functionality over formatting
